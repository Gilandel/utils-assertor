...
0. [Available methods](#available-methods)
	...
	1. [CharSequence](#charsequence)
	  ...
	  + [isNotEqualIgnoreCase](#isnotequalignorecase)
	  + [isEqualIgnoreLineReturns](#isequalignorelinereturns)
	  + [isNotEqualIgnoreLineReturns](#isnotequalignorelinereturns)
	  + [isEqualIgnoreCaseAndLineReturns](#isequalignorecaseandlinereturns)
	  + [isNotEqualIgnoreCaseAndLineReturns](#isnotequalignorecaseandlinereturns)
	  + [contains](#contains-1)
	...
	1. [Temporal](#temporal)
	  + [isAround](#isaround-1)
	  + [isNotAround](#isnotaround-1)
	  + [isAfter](#isafter-1)
	  + [isAfterOrEqual](#isafterorequal-1)
	  + [isBefore](#isbefore-1)
	  + [isBeforeOrEqual](#isbeforeorequal-1)
	1. [Enum](#enum)
	  + [hasName](#hasname-1)
	  + [hasNameIgnoreCase](#hasnameignorecase)
