...
0. [Description](#description)
	...
	0. [Reset explanations](#reset-explanations)
	0. [Message (locale, arguments and parameters)](#message-locale-arguments-and-parameters)
0. [Output details](#output-details)
	0. [orElseThrow](#orelsethrow)
	0. [isOK](#isok)
	0. [getErrors](#geterrors)
	0. [get](#get)
	0. [getNullable](#getnullable)
	0. [asResult](#asresult)
	0. [asDefault](#asdefault)
0. [Operators](#operators)
	...
	0. [NAND](#nand)
	0. [NOR](#nor)
0. [Available methods](#available-methods)
	0. [For all (Object, Boolean...)](#for-all-object-boolean)
		0. [isNull](#isnull)
		0. [isNotNull](#isnotnull)
		0. [isEqual](#isequal)
		0. [isNotEqual](#isnotequal)
		0. [isInstance](#isinstance)
		0. [isAssignableFrom](#isassignablefrom)
		0. [hasHashCode](#hashashcode)
		0. [validates](#validates)
	0. [Array](#array)
		0. [hasLength](#haslength)
		0. [isEmpty](#isempty)
		0. [isNotEmpty](#isnotempty)
		0. [contains](#contains)
		0. [containsAll](#containsall)
		0. [containsAny](#containsany)
	0. [Boolean](#boolean)
		0. [isTrue](#istrue)
		0. [isFalse](#isfalse)
	0. [CharSequence](#charsequence)
		0. [hasLength](#haslength)
		0. [isEmpty](#isempty-1)
		0. [isNotEmpty](#isnotempty-1)
		0. [isBlank](#isblank)
		0. [isNotBlank](#isnotblank)
		0. [isEqual](#isequal-1)
		0. [isNotEqual](#isnotequal-1)
		0. [isEqualIgnoreCase](#isequalignorecase)
		0. [isNotEqualIgnoreCase](#isnotequalignorecase)
		0. [isEqualIgnoreLineReturns](#isequalignorelinereturns)
		0. [isNotEqualIgnoreLineReturns](#isnotequalignorelinereturns)
		0. [isEqualIgnoreCaseAndLineReturns](#isequalignorecaseandlinereturns)
		0. [isNotEqualIgnoreCaseAndLineReturns](#isnotequalignorecaseandlinereturns)
		0. [contains](#contains-1)
		0. [startsWith](#startswith)
		0. [startsWithIgnoreCase](#startswithignorecase)
		0. [endsWith](#endswith)
		0. [endsWithIgnoreCase](#endswithignorecase)
		0. [matches](#matches)
		0. [find](#find)
	0. [Class](#class)
		0. [isAssignableFrom](#isassignablefrom-1)
		0. [hasName](#hasname)
		0. [hasSimpleName](#hassimplename)
		0. [hasCanonicalName](#hascanonicalname)
		0. [hasPackageName](#haspackagename)
		0. [hasTypeName](#hastypename)
	0. [Date & Calendar](#date-calendar)
		0. [isAround](#isaround)
		0. [isNotAround](#isnotaround)
		0. [isAfter](#isafter)
		0. [isAfterOrEqual](#isafterorequal)
		0. [isBefore](#isbefore)
		0. [isBeforeOrEqual](#isbeforeorequal)
	0. [Temporal](#temporal)
		0. [isAround](#isaround-1)
		0. [isNotAround](#isnotaround-1)
		0. [isAfter](#isafter-1)
		0. [isAfterOrEqual](#isafterorequal-1)
		0. [isBefore](#isbefore-1)
		0. [isBeforeOrEqual](#isbeforeorequal-1)
	0. [Enum](#enum)
		0. [hasName](#hasname-1)
		0. [hasNameIgnoreCase](#hasnameignorecase)
		0. [hasOrdinal](#hasordinal)
	0. [Iterable](#iterable)
		0. [hasSize](#hassize)
		0. [isEmpty](#isempty-1)
		0. [isNotEmpty](#isnotempty-1)
		0. [contains](#contains-2)
		0. [containsAll](#containsall-1)
		0. [containsAny](#containsany-1)
	0. [Map](#map)
		0. [hasSize](#hassize-1)
		0. [isEmpty](#isempty-2)
		0. [isNotEmpty](#isnotempty-2)
		0. [contains](#contains-3)
		0. [containsAll](#containsall-2)
		0. [containsAny](#containsany-2)
	0. [Number](#number)
		0. [isEqual](#isequal-2)
		0. [isNotEqual](#isnotequal-2)
		0. [isZero](#iszero)
		0. [isPositive](#ispositive)
		0. [isNegative](#isnegative)
		0. [isGT](#isgt)
		0. [isGTE](#isgte)
		0. [isLT](#islt)
		0. [isLTE](#islte)
