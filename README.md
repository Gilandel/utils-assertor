...
0. [Description](#description)
  + [Structure](#structure)
  + [Reset explanations](#reset-explanations)
  + [Message (locale, arguments and parameters)](#message-locale-arguments-and-parameters)
...
0. [Available methods](#available-methods)
  + [For all (Object, Boolean...)](#for-all-object-boolean)
    2. [isNull](#isnull)
    2. [isNotNull](#isnotnull)
    2. [isEqual](#isequal)
    2. [isNotEqual](#isnotequal)
    2. [isInstance](#isinstance)
    2. [isAssignableFrom](#isassignablefrom)
    2. [hasHashCode](#hashashcode)
    2. [validates](#validates)
  + [Array](#array)
    2. [hasLength](#haslength)
    2. [isEmpty](#isempty)
    2. [isNotEmpty](#isnotempty)
    2. [contains](#contains)
    2. [containsAll](#containsall)
    2. [containsAny](#containsany)
  + [Boolean](#boolean)
    2. [isTrue](#istrue)
    2. [isFalse](#isfalse)
  + [CharSequence](#charsequence)
    2. [hasLength](#haslength)
    2. [isEmpty](#isempty-1)
    2. [isNotEmpty](#isnotempty-1)
    2. [isBlank](#isblank)
    2. [isNotBlank](#isnotblank)
    2. [isEqual](#isequal-1)
    2. [isNotEqual](#isnotequal-1)
    2. [isEqualIgnoreCase](#isequalignorecase)
    2. [isNotEqualIgnoreCase](#isnotequalignorecase)
    2. [isEqualIgnoreLineReturns](#isequalignorelinereturns)
    2. [isNotEqualIgnoreLineReturns](#isnotequalignorelinereturns)
    2. [isEqualIgnoreCaseAndLineReturns](#isequalignorecaseandlinereturns)
    2. [isNotEqualIgnoreCaseAndLineReturns](#isnotequalignorecaseandlinereturns)
    2. [contains](#contains-1)
    2. [startsWith](#startswith)
    2. [startsWithIgnoreCase](#startswithignorecase)
    2. [endsWith](#endswith)
    2. [endsWithIgnoreCase](#endswithignorecase)
    2. [matches](#matches)
    2. [find](#find)
  + [Class](#class)
    2. [isAssignableFrom](#isassignablefrom-1)
    2. [hasName](#hasname)
    2. [hasSimpleName](#hassimplename)
    2. [hasCanonicalName](#hascanonicalname)
    2. [hasPackageName](#haspackagename)
    2. [hasTypeName](#hastypename)
  + [Date & Calendar](#date-calendar)
    2. [isAround](#isaround)
    2. [isNotAround](#isnotaround)
    2. [isAfter](#isafter)
    2. [isAfterOrEqual](#isafterorequal)
    2. [isBefore](#isbefore)
    2. [isBeforeOrEqual](#isbeforeorequal)
  + [Temporal](#temporal)
    2. [isAround](#isaround-1)
    2. [isNotAround](#isnotaround-1)
    2. [isAfter](#isafter-1)
    2. [isAfterOrEqual](#isafterorequal-1)
    2. [isBefore](#isbefore-1)
    2. [isBeforeOrEqual](#isbeforeorequal-1)
  + [Enum](#enum)
    2. [hasName](#hasname-1)
    2. [hasNameIgnoreCase](#hasnameignorecase)
    2. [hasOrdinal](#hasordinal)
  + [Iterable](#iterable)
    2. [hasSize](#hassize)
    2. [isEmpty](#isempty-1)
    2. [isNotEmpty](#isnotempty-1)
    2. [contains](#contains-2)
    2. [containsAll](#containsall-1)
    2. [containsAny](#containsany-1)
  + [Map](#map)
    2. [hasSize](#hassize-1)
    2. [isEmpty](#isempty-2)
    2. [isNotEmpty](#isnotempty-2)
    2. [contains](#contains-3)
    2. [containsAll](#containsall-2)
    2. [containsAny](#containsany-2)
  + [Number](#number)
    2. [isEqual](#isequal-2)
    2. [isNotEqual](#isnotequal-2)
    2. [isZero](#iszero)
    2. [isPositive](#ispositive)
    2. [isNegative](#isnegative)
    2. [isGT](#isgt)
    2. [isGTE](#isgte)
    2. [isLT](#islt)
    2. [isLTE](#islte)
