 ...
 */
@FunctionalInterface
public interface AssertorStepEnum<T extends Enum<T>> extends AssertorStep<StepEnum<T>, T> {
     ...
     */
    @Override
    default AssertorStepEnum<T> not() {
     ...
     * @return The operator
     */
    default StepEnum<T> hasName(final CharSequence name) {
     ...
     * @return The operator
     */
    default StepEnum<T> hasName(final CharSequence name, final CharSequence message, final Object... arguments) {
     ...
     * @return The operator
     */
    default StepEnum<T> hasName(final CharSequence name, final Locale locale, final CharSequence message, final Object... arguments) {
     ...
     * @return The operator
     */
    default StepEnum<T> hasNameIgnoreCase(final CharSequence name) {
     ...
     * @return The operator
     */
    default StepEnum<T> hasNameIgnoreCase(final CharSequence name, final CharSequence message, final Object... arguments) {
     ...
     * @return The operator
     */
    default StepEnum<T> hasNameIgnoreCase(final CharSequence name, final Locale locale, final CharSequence message,
     ...
     * @return The operator
     */
    default StepEnum<T> hasOrdinal(final int ordinal) {
     ...
     * @return The operator
     */
    default StepEnum<T> hasOrdinal(final int ordinal, final CharSequence message, final Object... arguments) {
     ...
     * @return The operator
     */
    default StepEnum<T> hasOrdinal(final int ordinal, final Locale locale, final CharSequence message, final Object... arguments) {
