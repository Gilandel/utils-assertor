...
public interface OperatorNor<S extends Step<S, T>, T> {
     ...
     * @return the assertor step
     */
    default <M extends Map<K, V>, K, V> AssertorStepMap<M, K, V> norMap(final Function<T, M> mapper) {
     ...
     * @return the assertor step
     */
    default <M extends Map<K, V>, K, V> AssertorStepMap<M, K, V> norMap(final Function<T, M> mapper, final EnumAnalysisMode analysisMode) {
