 ...
 * builder by returning a {@link PredicateAssertorThrowable}. The chain looks
 * like:
 * 
 * <pre>
 * {@link PredicateAssertorThrowable} &gt; {@link PredicateAssertorThrowable} &gt; {@link PredicateAssertorThrowable} &gt; {@link PredicateAssertorThrowable}...
 * </pre>
 * 
 * This chain always starts with a {@link PredicateAssertorThrowable} and ends
 * with {@link PredicateAssertorThrowable}.
 *
 * @since Aug 3, 2016
 * @author Gilles
 *
...
public interface PredicateAssertorThrowable<T extends Throwable> extends PredicateAssertor<PredicateStepThrowable<T>, T> {
     ...
     */
    @Override
    default PredicateAssertorThrowable<T> not() {
     ...
     * @return The operator
     */
    default PredicateStepThrowable<T> isInstanceOf(final Class<?> clazz, final CharSequence throwableMessage) {
     ...
     * @return The operator
     */
    default PredicateStepThrowable<T> isInstanceOf(final Class<?> clazz, final CharSequence throwableMessage, final CharSequence message,
            final Object... arguments) {
     ...
     * @return The operator
     */
    default PredicateStepThrowable<T> isInstanceOf(final Class<?> clazz, final CharSequence throwableMessage, final Locale locale,
            final CharSequence message, final Object... arguments) {
     ...
     * @return The operator
     */
    default PredicateStepThrowable<T> isInstanceOf(final Class<?> clazz, final Pattern pattern) {
     ...
     * @return The operator
     */
    default PredicateStepThrowable<T> isInstanceOf(final Class<?> clazz, final Pattern pattern, final CharSequence message,
            final Object... arguments) {
     ...
     * @return The operator
     */
    default PredicateStepThrowable<T> hasCauseNotNull(final CharSequence message, final Object... arguments) {
     ...
     * @return The operator
     */
    default PredicateStepThrowable<T> hasCauseNotNull(final Locale locale, final CharSequence message, final Object... arguments) {
     ...
     * @return The operator
     */
    default PredicateStepThrowable<T> hasCauseNull(final Locale locale, final CharSequence message, final Object... arguments) {
     ...
     * @return The operator
     */
    default PredicateStepThrowable<T> hasCauseAssignableFrom(final Class<?> clazz, final boolean recursively) {
     ...
     * @return The operator
     */
    default PredicateStepThrowable<T> hasCauseAssignableFrom(final Class<?> clazz, final boolean recursively, final CharSequence message,
            final Object... arguments) {
     ...
     * @return The operator
     */
    default PredicateStepThrowable<T> hasCauseAssignableFrom(final Class<?> clazz, final boolean recursively, final Locale locale,
            final CharSequence message, final Object... arguments) {
     ...
     * @return The operator
     */
    default PredicateStepThrowable<T> hasCauseAssignableFrom(final Class<?> clazz, final CharSequence exceptionMessage,
     ...
     * @return The operator
     */
    default PredicateStepThrowable<T> hasCauseAssignableFrom(final Class<?> clazz, final Pattern pattern, final boolean recursively) {
     ...
     * @return The operator
     */
    default PredicateStepThrowable<T> hasCauseInstanceOf(final Class<?> clazz, final boolean recursively) {
     ...
     * @return The operator
     */
    default PredicateStepThrowable<T> hasCauseInstanceOf(final Class<?> clazz, final boolean recursively, final CharSequence message,
            final Object... arguments) {
     ...
     * @return The operator
     */
    default PredicateStepThrowable<T> hasCauseInstanceOf(final Class<?> clazz, final boolean recursively, final Locale locale,
            final CharSequence message, final Object... arguments) {
     ...
     * @return The operator
     */
    default PredicateStepThrowable<T> hasCauseInstanceOf(final Class<?> clazz, final CharSequence exceptionMessage,
            final boolean recursively) {
     ...
     * @return The operator
     */
    default PredicateStepThrowable<T> hasCauseInstanceOf(final Class<?> clazz, final Pattern pattern, final boolean recursively) {
