 ...
 * builder by returning a {@link StepTemporal}. The chain looks like:
 * 
 * <pre>
 * {@link AssertorStepTemporal} &gt; {@link StepTemporal} &gt; {@link AssertorStepTemporal} &gt; {@link StepTemporal}...
 * </pre>
 * 
 * This chain always starts with a {@link AssertorStepTemporal} and ends with
 * {@link StepTemporal}.
 *
 * @since Aug 3, 2016
 * @author Gilles
 ...
 */
@FunctionalInterface
public interface AssertorStepTemporal<T extends Temporal & Comparable<T>> extends AssertorStep<StepTemporal<T>, T> {
     ...
     */
    @Override
    default AssertorStepTemporal<T> not() {
     ...
     */
    default StepTemporal<T> isEqual(final T temporal) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isEqual(final T temporal, final CharSequence message, final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isEqual(final T temporal, final Locale locale, final CharSequence message, final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isNotEqual(final T temporal) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isNotEqual(final T temporal, final CharSequence message, final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isNotEqual(final T temporal, final Locale locale, final CharSequence message, final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isAround(final T temporal, final TemporalAmount temporalAmount) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isAround(final T temporal, final TemporalAmount temporalAmount, final CharSequence message,
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isAround(final T temporal, final TemporalAmount temporalAmount, final Locale locale, final CharSequence message,
            final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isNotAround(final T temporal, final TemporalAmount temporalAmount) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isNotAround(final T temporal, final TemporalAmount temporalAmount, final CharSequence message,
            final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isNotAround(final T temporal, final TemporalAmount temporalAmount, final Locale locale,
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isAfter(final T temporal) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isAfter(final T temporal, final CharSequence message, final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isAfter(final T temporal, final Locale locale, final CharSequence message, final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isAfter(final T temporal, final TemporalAmount temporalAmount) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isAfter(final T temporal, final TemporalAmount temporalAmount, final CharSequence message,
            final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isAfter(final T temporal, final TemporalAmount temporalAmount, final Locale locale, final CharSequence message,
            final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isAfterOrEqual(final T temporal) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isAfterOrEqual(final T temporal, final CharSequence message, final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isAfterOrEqual(final T temporal, final Locale locale, final CharSequence message, final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isAfterOrEqual(final T temporal, final TemporalAmount temporalAmount) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isAfterOrEqual(final T temporal, final TemporalAmount temporalAmount, final CharSequence message,
            final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isAfterOrEqual(final T temporal, final TemporalAmount temporalAmount, final Locale locale,
            final CharSequence message, final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isBefore(final T temporal) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isBefore(final T temporal, final CharSequence message, final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isBefore(final T temporal, final Locale locale, final CharSequence message, final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isBefore(final T temporal, final TemporalAmount temporalAmount) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isBefore(final T temporal, final TemporalAmount temporalAmount, final CharSequence message,
            final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isBefore(final T temporal, final TemporalAmount temporalAmount, final Locale locale, final CharSequence message,
            final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isBeforeOrEqual(final T temporal) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isBeforeOrEqual(final T temporal, final CharSequence message, final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isBeforeOrEqual(final T temporal, final Locale locale, final CharSequence message, final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isBeforeOrEqual(final T temporal, final TemporalAmount temporalAmount) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isBeforeOrEqual(final T temporal, final TemporalAmount temporalAmount, final CharSequence message,
            final Object... arguments) {
     ...
     * @return the assertor step
     */
    default StepTemporal<T> isBeforeOrEqual(final T temporal, final TemporalAmount temporalAmount, final Locale locale,
            final CharSequence message, final Object... arguments) {
