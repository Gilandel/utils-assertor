 ...
 */
@FunctionalInterface
public interface PredicateStep<S extends PredicateStep<S, T>, T> extends PredicateOperatorAnd<S, T>, PredicateOperatorNand<S, T>,
        PredicateOperatorNor<S, T>, PredicateOperatorOr<S, T>, PredicateOperatorXor<S, T> {
