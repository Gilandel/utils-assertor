...
public interface PredicateAssertorStepIterable<I extends Iterable<T>, T> extends PredicateAssertorStep<PredicateStepIterable<I, T>, I> {
     ...
     * @category no_message
     */
    default PredicateStepIterable<I, T> anyMatch(final Predicate<T> predicate) {
     ...
     * @category message
     */
    default PredicateStepIterable<I, T> anyMatch(final Predicate<T> predicate, final CharSequence message, final Object... arguments) {
     ...
     */
    default PredicateStepIterable<I, T> anyMatch(final Predicate<T> predicate, final Locale locale, final CharSequence message,
            final Object... arguments) {
     ...
     * @category no_message
     */
    default PredicateStepIterable<I, T> allMatch(final Predicate<T> predicate) {
     ...
     * @category message
     */
    default PredicateStepIterable<I, T> allMatch(final Predicate<T> predicate, final CharSequence message, final Object... arguments) {
     ...
     * @category localized_message
     */
    default PredicateStepIterable<I, T> allMatch(final Predicate<T> predicate, final Locale locale, final CharSequence message,
            final Object... arguments) {
