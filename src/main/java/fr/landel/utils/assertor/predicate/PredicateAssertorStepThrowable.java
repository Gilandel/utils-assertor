 ...
 */
@FunctionalInterface
public interface PredicateAssertorStepThrowable<T extends Throwable> extends PredicateAssertorStep<PredicateStepThrowable<T>, T> {
     ...
     */
    @Override
    default PredicateAssertorStepThrowable<T> not() {
     ...
     * @return The operator
     */
    default PredicateStepThrowable<T> hasCauseAssignableFrom(final Class<?> clazz, final Pattern pattern,
            final boolean recursively) {
