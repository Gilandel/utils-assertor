...
public class AssertorThrowable extends ConstantsAssertor {
     ...
     */
    public static <T extends Throwable> StepAssertor<T> isInstanceOf(final StepAssertor<T> step, final Class<?> type,
     ...
     * @return the next step
     */
    public static <T extends Throwable> StepAssertor<T> isInstanceOf(final StepAssertor<T> step, final Class<?> type, final Pattern pattern,
     ...
     * @return the next step
     */
    public static <T extends Throwable> StepAssertor<T> isAssignableFrom(final StepAssertor<T> step, final Class<?> type,
            final CharSequence exceptionMessage, final MessageAssertor message) {
     ...
     * @return the next step
     */
    public static <T extends Throwable> StepAssertor<T> hasCauseNull(final StepAssertor<T> step, final MessageAssertor message) {
     ...
     * @return the next step
     */
    public static <T extends Throwable> StepAssertor<T> hasCauseNotNull(final StepAssertor<T> step, final MessageAssertor message) {
     ...
     * @return the next step
     */
    public static <T extends Throwable> StepAssertor<T> hasCauseInstanceOf(final StepAssertor<T> step, final Class<?> causeType,
     ...
     * @return the next step
     */
    public static <T extends Throwable> StepAssertor<T> hasCauseAssignableFrom(final StepAssertor<T> step, final Class<?> causeType,
            final boolean resursively, final MessageAssertor message) {
