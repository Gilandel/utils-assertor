...
public class AssertorBoolean extends ConstantsAssertor {
     ...
     */
    public static StepAssertor<Boolean> isTrue(final StepAssertor<Boolean> step, final MessageAssertor message) {
     ...
     * @return the next step
     */
    public static StepAssertor<Boolean> isFalse(final StepAssertor<Boolean> step, final MessageAssertor message) {
